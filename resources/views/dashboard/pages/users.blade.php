              ...
              e.querySelectorAll(
                  ...
                  e.addEventListener("click", function (e) {
                      ...
                      Swal.fire({
                        ...
                        if (e.value) {
                            $.ajax({
                                url: "{{ route('users.destroy', ['id' => ':id']) }}".replace(':id', n),
                                type: 'DELETE',
                                headers: {
                                ...
                                success: function (response) {
                                    Swal.fire({
                                        text: "Berhasil menghapus Nomor Anggota " + n + "!",
                                        icon: "success",
                                        buttonsStyling: false,
                                ...
                                error: function (xhr, status, error) {
                                    Swal.fire({
                                        text: "Gagal menghapus Nomor Anggota " + n + ". Silakan coba lagi.",
                                        icon: "error",
                                        buttonsStyling: false,
                                        confirmButtonText: "OK mengerti!",
                                        customClass: {
                            ...
                            Swal.fire({
                                text: "Nomor Anggota " + n + " tidak dihapus.",
                                icon: "error",
                                buttonsStyling: false,
                                confirmButtonText: "OK mengerti!",
                                customClass: {
          ...
          n = () => {
              ...
              o.forEach((t) => {
                  ...
                  n.addEventListener("click", function () {
                      Swal.fire({
                          text: "Apakah Anda yakin ingin menghapus Anggota yang dipilih?",
                          icon: "warning",
                          showCancelButton: !0,
                          buttonsStyling: !1,
